...
public class AtyUtils {
     ...
     * @param email
     */
    public static void sendEmail(AfActivity activity, String email) {
     ...
     * @param text     这是内容
     */
    public static void sendEmail(AfActivity activity, String email, String cc, String subject, String text) {
        ...
        activity.startActivity(Intent.createChooser(data, activity.getString(R.string.email_title)));
    }
     ...
     */
    public static void cacheFile(Context context, String url, OnCallbackListener callbackListener) {
    ...
    public static void cacheFile(Context context, String url,
        ...
        if (localFile.exists()) {
            ...
            if (callbackListener != null) {
                callbackListener.onCallback(1, localFile);
            }
        } else {
            //网络文件
            ...
            if (file.exists()) {
                //已经下载
                if (callbackListener != null) {
                    callbackListener.onCallback(2, file);
                }
            } else {
                ...
                request.start(new com.downloader.OnDownloadListener() {
                    ...
                    public void onDownloadComplete() {
                        //下载成功
                        if (callbackListener != null) {
                            callbackListener.onCallback(3, file);
                        }
                    }
