...
import cn.appoa.aframework.net.NetStateChangeObserver;
import cn.appoa.aframework.net.NetStateChangeReceiver;
import cn.appoa.aframework.net.NetworkType;
...
public abstract class AfActivity<P extends BasePresenter> extends SlideBackActivity
        implements IBaseView, Foreground.ForegroundListener, NetStateChangeObserver {
     ...
     * 初始化Titlebar
     */
    protected BaseTitlebar initTitlebar() {
        return null;
    }
