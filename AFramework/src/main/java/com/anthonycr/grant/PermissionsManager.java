...
public class PermissionsManager {
     ...
     * that you call this from a Fragment where {@link androidx.fragment.app.Fragment#getActivity()} could yield
     ...
     * PermissionsResultAction to the queue to be notified of permissions being granted or
     * denied. In the case of pre-Android Marshmallow, permissions will be granted immediately.
     * The Fragment variable is used, but if {@link androidx.fragment.app.Fragment#getActivity()} returns null, this method
     ...
     */
    @SuppressWarnings("unused")
    public synchronized void requestPermissionsIfNecessaryForResult(@NonNull androidx.fragment.app.Fragment fragment,
                                                                    @NonNull String[] permissions,
                                                                    @Nullable PermissionsResultAction action) {
     ...
     * the {@link androidx.fragment.app.Fragment#onRequestPermissionsResult(int, String[], int[])} method.
