...
import com.scwang.smartrefresh.layout.adapter.ZmBaseMultiItemQuickAdapter;
import com.scwang.smartrefresh.layout.adapter.ZmBaseQuickAdapter;
...
public class SmartRefreshRecyclerViewFragment extends BaseRecyclerFragment<RefreshBean> {
     ...
     * 多布局Adapter
     */
    class MultiItemQuickAdapter extends ZmBaseMultiItemQuickAdapter<RefreshBean> {
    ...
    @Override
    public ZmBaseQuickAdapter<RefreshBean> initAdapter() {
    ...
    @Override
    public void initHeaderView(ZmBaseQuickAdapter<RefreshBean> adapter) {
        if (headerView != null) {
    ...
    @Override
    public void initFooterView(ZmBaseQuickAdapter<RefreshBean> adapter) {
        if (footerView != null) {
