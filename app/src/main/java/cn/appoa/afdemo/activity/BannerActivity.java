...
public class BannerActivity extends BaseActivity {
    ...
    private void getBanner(final int type) {
        ...
        ZmOkGo.request(API.posterlist, params).tag(this.getRequestTag())
                .execute(new OkGoDatasListener<BannerBean>(this, "广告列表", BannerBean.class) {
                    @Override
        ...
        if (banners != null && banners.size() > 0) {
            ...
            ultraViewPager.setAdapter(new PagerAdapter() {
                ...
                public Object instantiateItem(ViewGroup container, final int position) {
                    ...
                    AfApplication.imageLoader.loadImage(API.IMAGE_URL + banner.Pic, imageView);
