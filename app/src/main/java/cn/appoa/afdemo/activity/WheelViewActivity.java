...
public class WheelViewActivity extends BaseActivity
    ...
    private void getGoodsTypeList() {
        ...
        ZmOkGo.request("", params).tag(this.getRequestTag())
                .execute(new OkGoDatasListener<GoodsTypeList>(this, "商品类型", GoodsTypeList.class) {
                    @Override
    ...
    private void getGoodsCategoryList() {
        Map<String, String> params = new HashMap<>();
        ZmOkGo.request("", params).tag(this.getRequestTag())
                .execute(new OkGoDatasListener<GoodsCategoryList>(this, "商品分类", GoodsCategoryList.class) {
                    @Override
