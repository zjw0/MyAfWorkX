...
public abstract class PullToRefreshRecyclerViewFragment<T> extends PullToRefreshBaseFragment<RecyclerView> {
     ...
     * 适配器
     */
    protected ZmBaseQuickAdapter<T> adapter;
     ...
     * @return
     */
    public abstract ZmBaseQuickAdapter<T> initAdapter();
     ...
     * 初始化头布局
     */
    public void initHeaderView(ZmBaseQuickAdapter<T> adapter) {
     ...
     * 初始化脚部局
     */
    public void initFooterView(ZmBaseQuickAdapter<T> adapter) {
